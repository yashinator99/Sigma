...
from models.register_dto import Register
from database.login_dao import insert_user, select_user_by_id
from database.register_info_dao import insert_user_info
from service.validation_service import validate_info, validate_login
